...
class ArticleList extends React.PureComponent<IArticleListProps> {
  ...
  getCategoryNameByArticleIdx = (index: string) => {
    ...
    return (this.props.categories.data[idxOfCategory] === undefined ? 'category was deleted or undefined' : this.props.categories.data[idxOfCategory].name);
  };
  ...
  render() {
    ...
    <div className='articlePreviewList'>
      <div className='articlePreviewHeader'>
        ...
        <div className='article_preview_header_ceil'><span className="article_preview_header_title">category</span></div>
        <div className='article_preview_header_ceil'><span className="article_preview_header_title">created at</span></div>
        <div className='article_preview_header_ceil'><span className="article_preview_header_title">updated at</span></div>
      </div>
        {
