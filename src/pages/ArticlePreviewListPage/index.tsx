...
class ArticlesPreviewListPage extends React.PureComponent<
  ArticlePreviewListPageProps,
  ArticlesPreviewListPageState
> {
  ...
  render() {
    ...
    return (
      <div className="article_preview_list_page">
        ...
        <ArticleList />
        {isLogged ? (
          <ArticlesPreviewButtons
            createNewArticle={() =>
              this.changeDisplay(DisplayStatus.CreateNewArticle)
            }
            editCategories={() =>
              this.changeDisplay(DisplayStatus.EditCategories)
            }
          />
        ) : null}
