import { CREATE_ARTICLE, SAVE_ARTICLES, SAVE_ARTICLE, UPDATE_ARTICLE, DELETE_ARTICLE,
  LOADING_ARTICLE_ON, LOADING_ARTICLE_OFF, WRITE_ERROR_ARTICLE, IArticle } from '../types/redux/articles'
